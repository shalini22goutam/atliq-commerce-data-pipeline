...
Windows only appear after they close — the watermark must pass the window's end first. So rows show up 10–15 minutes behind real time. That is correctness (waiting for late events), not a bug. Explain WHY? 

### WHY a window appears after the watermark passes its end?
